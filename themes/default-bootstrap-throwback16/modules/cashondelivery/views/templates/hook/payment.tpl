...
<div class="row">
	<div class="col-xs-12">
        ...
        <div class="row">
        	<div class="col-xs-12">
        		En validant votre commande, vous acceptez et déclarez avoir pris connaissance des <a href="#test-popup" class="open-popup-link">conditions générales de vente</a>.
        	</div>
        </div>
