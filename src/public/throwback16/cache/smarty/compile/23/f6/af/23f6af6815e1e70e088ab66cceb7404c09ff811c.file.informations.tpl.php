<?php /* Smarty version Smarty-3.1.19, created on 2017-02-19 19:41:50
         compiled from "/vagrant/public/throwback16/override/controllers/admin/templates/products/informations.tpl" */ ?>
<?php /*%%SmartyHeaderCode:63977451758a9e6ee167d91-75112792%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '23f6af6815e1e70e088ab66cceb7404c09ff811c' => 
    array (
      0 => '/vagrant/public/throwback16/override/controllers/admin/templates/products/informations.tpl',
      1 => 1487272550,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '63977451758a9e6ee167d91-75112792',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58a9e6ef5c0404_69740446',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58a9e6ef5c0404_69740446')) {function content_58a9e6ef5c0404_69740446($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/vagrant/public/throwback16/tools/smarty/plugins/modifier.date_format.php';
?>
	...
	<hr/>
        ...
        <div class="form-group">
             <label class="control-label col-lg-3" for="date-creation">
                 <span class="label-tooltip" data-toggle="tooltip"
                         title="<?php echo smartyTranslate(array('s'=>"Date d\'ajout"),$_smarty_tpl);?>
">
                         <?php echo $_smarty_tpl->tpl_vars['bullet_common_field']->value;?>
 <?php echo smartyTranslate(array('s'=>"Date d\'ajout"),$_smarty_tpl);?>

                 </span>
             </label>
             <div class="col-lg-3">
                 <input maxlength="19" type="text" id="date_add" name="date_add" value="<?php echo smarty_modifier_date_format(smarty_modifier_htmlentitiesUTF8($_smarty_tpl->tpl_vars['product']->value->date_add),'%Y-%m-%d %H:%M:%S');?>
" />
             </div>
        </div>
        <hr/>
