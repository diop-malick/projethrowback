...
$(document).ready(function() {
    ...
    /* --------------------------------------------------------------------- 
     * Disable availability message on page load
     * on color attribute
     * --------------------------------------------------------------------- */
...
$(document).on('click', '.attribute_radio', function(e) {
    ...
    // 0000262: [TS][MOB][FP] Actualiser le champ quantité sur la FP à chaque sélection de taille
    fieldName = 'qty';
...
function findCombination() 
{
    ...
    if (typeof combinationsHashSet !== 'undefined') {
        ...
        if (combination) {
            ...
            //update the display
            updateDisplay();
            console.log('findCombination > updateDisplay > inside ');
    ...
    updateDisplay();
    console.log('findCombination > updateDisplay > outside');
}
