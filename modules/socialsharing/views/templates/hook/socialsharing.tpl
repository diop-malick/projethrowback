...
{if $PS_SC_TWITTER || $PS_SC_FACEBOOK || $PS_SC_GOOGLE || $PS_SC_PINTEREST}
	...
	<p class="socialsharing_product list-inline no-print">
		{if $PS_SC_TWITTER}
			<button data-easyshare-button="twitter" data-easyshare-tweet-text="" data-type="twitter" type="button" class="btn btn-default btn-twitter social-sharing">
		...
		{/if}
		{if $PS_SC_FACEBOOK}
			<button data-easyshare-button="facebook" data-type="facebook" type="button" class="btn btn-default btn-facebook social-sharing">
		...
		{/if}
		{if $PS_SC_GOOGLE}
			<button data-easyshare-button="google" data-type="google-plus" type="button" class="btn btn-default btn-google-plus social-sharing">
		...
		{/if}
		{if $PS_SC_PINTEREST}
			<button data-easyshare-button="pinterest" data-type="pinterest" type="button" class="btn btn-default btn-pinterest social-sharing">
		...
		{/if}
		<span class="btn btn-default social-sharing" data-easyshare-button="total">
		<span>Total</span>
	</span>
